...
export function AppsItem({ origin }: { origin: Origin }) {
  ...
  const url = originManager.url(origin)
    ...
    <div className="pb-8">
      ...
      <Well>
        ...
        <Splitter />
          ...
          </Dropdown> : <div className='flex justify-center'>
              <a className='text-center' href={url} title={url} target="_blank">
              Open app in new tab
              </a>
          </div>}
      </Well>
