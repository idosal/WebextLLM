        ...
        <div className='mt-4'>
          <Well>
            <>
              ...
              <Text>Harness the power of local LLMs to fuel a growing AI-based app ecosystem.</Text>
              <br/>
              <Text>Key features:</Text>
              <li>Own your models: Experience the freedom of owning your LLMs, enjoying a limitless, private, and secure environment</li>
